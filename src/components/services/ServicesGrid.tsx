      ...
      {services.map((service, index) => {
          ...
          return (
            ...
            >
              ...
              <div className="relative flex flex-col h-full">
                ...
                <Link href="/contact" className="inline-flex items-center gap-2 text-sm font-semibold text-turquoise hover:text-white transition-colors duration-200 mt-auto">
                  {t("Get Started", "ابدأ الآن")}
                  <ArrowRight className={`h-4 w-4 transition-transform duration-200 group-hover:translate-x-1 ${isAr ? "rotate-180" : ""}`} />
                </Link>
              </div>
            </motion.article>
          );
        ...
        return (
          ...
          >
            ...
            <Link href="/contact" className="inline-flex items-center gap-2 text-sm font-semibold text-turquoise hover:text-[#009ea0] transition-colors duration-200 mt-auto">
              {t("Get Started", "ابدأ الآن")}
              <ArrowRight className={`h-4 w-4 transition-transform duration-200 group-hover:translate-x-1 ${isAr ? "rotate-180" : ""}`} />
            </Link>
          </motion.article>
