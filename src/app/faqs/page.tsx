  ...
  return (
    <div
      className={`border rounded-xl overflow-hidden transition-all duration-200 ${
        open ? "border-turquoise/40 shadow-sm" : "border-gray-100"
      } bg-white`}
    >
      <button
            ...
            <button
              ...
              className={`px-4 py-2 rounded-full text-sm font-medium transition-all duration-200 ${
                activeCategory === null
                  ...
                  : "bg-gray-100 text-gray-600 hover:bg-turquoise/10 hover:text-turquoise"
              }`}
            >
              All Topics
            </button>
        ...
        <div className="container-wide max-w-3xl">
          ...
          <ScrollReveal>
            <div className="mt-12 bg-gradient-to-br from-[#020b13] to-[#0a1e35] rounded-2xl p-8 text-center border border-turquoise/10">
              ...
              <h3 className="font-bold text-white text-lg mb-2" style={{ fontFamily: "var(--font-sans)" }}>
        ...
        <div className="container-wide max-w-4xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            {policies.map((policy, index) => (
              <ScrollReveal key={policy.id} delay={index * 0.1}>
                <div
                  id={policy.title.toLowerCase().replace(/\s+/g, "-")}
                  className="group bg-white rounded-2xl p-7 shadow-sm border border-gray-100 hover:border-turquoise/30 hover:-translate-y-1 hover:shadow-md transition-all duration-300 scroll-mt-40"
                >
                  <div className="flex items-center gap-3 mb-4">
                    <div className="w-10 h-10 rounded-xl bg-turquoise/10 flex items-center justify-center group-hover:bg-turquoise transition-colors duration-300">
                  ...
                  <p className="text-gray-500 text-sm leading-relaxed">{policy.content}</p>
                </div>
              </ScrollReveal>
            ))}
          </div>
          ...
          <ScrollReveal>
            <div className="mt-10 text-center">
              ...
              <Link href="/contact" className="text-turquoise text-sm font-semibold hover:underline">
